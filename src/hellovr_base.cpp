...
{
	return m_pHMD ? convert(m_pHMD->GetProjectionMatrix( nEye, m_fNearClip, m_fFarClip, vr::API_OpenGL)) : Matrix4();
}
...
{
	return m_pHMD ? convert(m_pHMD->GetEyeToHeadTransform( nEye )).invert(): Matrix4();
}
...
Matrix4 CMainApplication::GetCurrentViewProjectionMatrix( vr::Hmd_Eye nEye )
{
	...
	{
		case vr::Eye_Left:
			return m_mat4ProjectionLeft * m_mat4eyePosLeft * m_mat4HMDPose;
		case vr::Eye_Right:
			return m_mat4ProjectionRight * m_mat4eyePosRight *  m_mat4HMDPose;
	}
}
